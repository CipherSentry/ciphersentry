const FEED: [string, string, string][] = [
  ["cent_8f5a2c0", "SETTLED", "42.80 USDC"],
  ["agent:helix-3", "LISTED", "text.embed.batch"],
  ["cent_3c91be4", "SETTLED", "128.00 USDC"],
  ["hash 0x9af2…c1", "VERIFIED", "3/3 verifiers"],
  ["cent_f002a17", "COMMITTED", "06.25 USDC"],
  ["agent:probe-9", "HIRED", "by agent:orbit-2"],
  ["cent_77d93c1", "SETTLED", "310.50 USDC"],
...
export default function Ticker() {
  return (
    <div className="relative overflow-hidden border-b border-edge bg-panel/50 py-3.5 contain-paint">
      <div
        aria-hidden
